...
export default function ProfileCard({ profile, onSwipeLeft, onSwipeRight, isActive, style = {}, isMatch = false }: ProfileCardProps) {
  ...
  // Trigger match animation when isMatch changes to true
  useEffect(() => {
    if (isMatch) {
    ...
    <>
      ...
      <motion.div
        ...
        animate={{ 
          ...
          x: isMatch ? [0, -10, 10, -10, 10, 0] : 0,
          rotate: isMatch ? [0, -5, 5, -5, 5, 0] : 0,
        }}
        transition={{ 
          duration: 0.2,
          x: isMatch ? { duration: 0.5, times: [0, 0.2, 0.4, 0.6, 0.8, 1] } : undefined,
          rotate: isMatch ? { duration: 0.5, times: [0, 0.2, 0.4, 0.6, 0.8, 1] } : undefined,
        }}
      ...
      >
        ...
        <div className="relative h-full w-full">
          ...
          {/* Swipe indicators */}
          <motion.div 
            className="absolute top-8 right-8 rounded-full bg-green-500 p-3"
            style={{ opacity: useTransform(x, [0, 100], [0, 1]) }}
          >
            <HeartIcon className="w-8 h-8 text-white" />
          </motion.div>
          <motion.div 
            className="absolute top-8 left-8 rounded-full bg-red-500 p-3"
