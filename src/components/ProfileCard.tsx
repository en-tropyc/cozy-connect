...
export default function ProfileCard({ profile, onSwipeLeft, onSwipeRight, isActive, style = {} }: ProfileCardProps) {
  ...
  return (
    <motion.div
      ...
      animate={{ scale: style.scale ?? 1, opacity: style.opacity ?? 1 }}
